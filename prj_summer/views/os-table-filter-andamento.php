...
if ($numeroOs > 0) {
    ...
    echo '
        ...
        <table class="os-table-andamento table display table-hover" width="100%" cellspacing="0">
            <thead>
                <tr>
    ...
    echo "<div class='lista_andamento alert alert-info'>Nenhuma Ordem de serviço em andamento!</div>";
}
?>
